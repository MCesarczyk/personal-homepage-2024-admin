...
const buttonStyles = {
  ...
  SECONDARY:
    "py-2 md:py-3 px-3 md:px-4 rounded bg-transparent text-blue-800 dark:text-blue-500 font-normal border-transparent border-b-2 hover:scale-105 active:scale-100 transition-all duration-300",
};
